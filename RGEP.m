function V = RGEP(vd, f, grad, D, V0, opts)
...
%--------------------------------------------------------------------------
    ...
    if ~exist('opts', 'var')
        opts = struct();
        defaults.roh1 = 0.001;           % Wolfe condition c1 - step length (Armijo)
        defaults.roh2 = 0.999;           % Wolfe condition c2 - curvature
        ...
        defaults.max_iter = 10000;      % maximum iteration
